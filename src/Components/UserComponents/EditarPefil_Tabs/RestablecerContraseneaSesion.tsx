...
import {cambioContraseniaServices} from '../../../services/ResetPwdSession'; //Servicio para enviar la solicitud de cambio de contraseña
...
//en este caso lo que viene de type en generalForm.ts con los objetos de cambioContraseña.
  ...
  */
  const handleCambioContraseña = async (formData: resetPwdSession) =>{
    try {
