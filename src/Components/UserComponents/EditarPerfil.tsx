...
import ResetPwdSession from './EditarPefil_Tabs/RestablecerContraseneaSesion';//Es la importacion del componente que se encarga de cambiar la contraseña
...
const tabs: Tab[] = [//En este apartado creamos una funcion de arreglo en donde va tener todo el contenido,
  {
    ...
    content: <ResetPwdSession /> //En esta parte tenemos el contenido que se va renderizar en la pestaña de EditarPerfil, en este caso es el componente de CambioContraseñaUsuario
  },
