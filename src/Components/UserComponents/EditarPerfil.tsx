...
import CambioContrasenaUsuario from './EditarPefil_Tabs/RestablecerContraseneaSesion'//Es la importacion del componente que se encarga de cambiar la contraseña
