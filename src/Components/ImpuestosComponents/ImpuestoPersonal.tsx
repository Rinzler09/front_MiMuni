...
const ImpuestoPersonal: React.FC = () => {
  ...
  return (
    <div className="detalles-impuesto-container">
      <h2 className="title">
        PROCESO DE FACTURACION DE IMPUESTO PERSONAL (VECINAL)
      </h2>
      <Municipalidad />
      <h2
        className="titles"
        style={{ background: "#FF6600", fontSize: "16px" }}
      >
      ...
      <div className="entity-identification">
        ...
        <div className="row">
          <div className="column">
            <label>Nombre Contribuyentes</label>
      ...
      <table className="details-table">
        ...
        <tbody>
          {/* Año 2021 */}
          <tr>
            <td style={{ textAlign: "center" }}>IMPUESTO PERSONAL</td>
            <td style={{ textAlign: "center" }}>2023</td>
            <td style={{ textAlign: "center" }}>03-36170507392</td>
            <td style={{ textAlign: "center" }}>31/04/2023</td>
            <td style={{ textAlign: "center" }}>1.037.79</td>
            <td style={{ textAlign: "center" }}>46.77</td>
            <td style={{ textAlign: "center" }}>1,808.00</td>
            <td style={{ textAlign: "center" }}>
              <input
                type="checkbox"
                onChange={(e) => handleCheckboxChange(e, 6200, 2019)}
              />
            </td>
          </tr>
          {/* Año 2024 */}
          <tr>
            ...
            <td style={{ textAlign: "center" }}>03-36170507324</td>
            <td style={{ textAlign: "center" }}>31/04/2024</td>
            <td style={{ textAlign: "center" }}>1.037.79</td>
            <td style={{ textAlign: "center" }}>46.77</td>
            <td style={{ textAlign: "center" }}>2,630.00</td>
            <td style={{ textAlign: "center" }}>
              <input
                type="checkbox"
                onChange={(e) => handleCheckboxChange(e, 6200, 2019)}
      ...
      {showConfirmationModal && (
        <div className="modal-overlay">
          <div className="modal-box">
            ...
            {showOkButton && (
              <Link to="/Proceso-FacturacionIPPDF" className="modal-button">
                OK
              </Link>
            )}
          </div>
