    ...
    <div className="layout">
      <div className="layout-content">
        <main className="main-content full-carousel-container">
          <div
            id="carouselExampleIndicators"  className="carousel slide carousel-fade full-carousel"
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                ...
                <img src="/img/alcaldia.jpg" className="d-block carousel-image"  alt="Alcaldía"/>
              ...
              <div className="carousel-item">
                ...
                <img src="/img/noticias.jpg" className="d-block carousel-image" alt="Noticias"/>
                <div className="carousel-caption d-none d-md-block">
              ...
              <div className="carousel-item">
                <img  src="/img/Santa.jpg"
                  className="d-block carousel-image" alt="Santa Lucía"/>
                <div className="carousel-caption d-none d-md-block">
