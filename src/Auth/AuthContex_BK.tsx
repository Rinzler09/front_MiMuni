...
//     useEffect(() => {
//         setAuthToken(sessionStorage.getItem("access_TKN"));
//         console.log("Cambio el token en Auth Context, este es el nuevo token: ", token);
//     }, [token]);
...
//             if (authHeader) {
//                 console.log("Prueba Milton: Extraccion del cabeceras de la response: ", authHeader);
//                 return;
...
//     useEffect(() => {
//         console.log("AuthContext useEffect de renovación, token actual:", token);
